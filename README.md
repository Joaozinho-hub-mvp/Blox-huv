# Blox-huvif game.PlaceId == 2753915549 then
    World1 = true
...
local Window = OrionLib:MakeWindow({Name = "JOÃOZINHO HUB", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "JOÃOZINHO HUB"})
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "JOÃOZINHO HUB(Noitification)",
...
OrionLib:MakeNotification({
    Name = "OBG PELA ESCOLHER JOÃOZINHO HUB 
de João Gabriel gamarros ",
